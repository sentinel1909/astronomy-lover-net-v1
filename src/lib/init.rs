...
use crate::routes::handlers::{
    handle_count, handle_echo, handle_health_check, handle_metrics, handle_ping,
    handle_reset_metrics, handle_static_files,
};
...
pub fn build_route_table() -> RouteTable {
    ...
    table.insert(HyperMethod::GET, "/_health", handle_health_check as HandlerFn);
    ...
    table.insert(HyperMethod::GET, "/{*path}", handle_static_files as HandlerFn);
